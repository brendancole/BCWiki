...
#define DEFAULT_MYSQL_HOME "@@BITROCK_MYSQL_ROOTDIR@@"
#define SHAREDIR "@@BITROCK_MYSQL_ROOTDIR@@/share"
#define DEFAULT_BASEDIR "@@BITROCK_MYSQL_ROOTDIR@@"
#define MYSQL_DATADIR "@@BITROCK_MYSQL_ROOTDIR@@/data"
#define DEFAULT_CHARSET_HOME "@@BITROCK_MYSQL_ROOTDIR@@"
#define PLUGINDIR "@@BITROCK_MYSQL_ROOTDIR@@/lib/plugin"
#define DEFAULT_SYSCONFDIR "@@BITROCK_MYSQL_ROOTDIR@@/etc"
...
#define PACKAGE_STRING "MySQL Server 5.6.33"
#define PACKAGE_TARNAME "mysql"
#define PACKAGE_VERSION "5.6.33"
#define VERSION "5.6.33"
